...
import com.ds.news.utils.create
...
class NewsSourceServiceTest : BaseServiceTest() {
    ...
    fun getNewsSource() = runBlocking {
        ...
        assertThat(article1.author, `is`("DS"))
        assertThat(article1.title, `is`("Google Pixel 6"))
        assertThat(article1.description, `is`("Gift me Google Pixel 6 ;)"))
        assertThat(article1.source.name, `is`("BBC"))
    }
}